...
urlpatterns = [ 
    ...
    path('clearselection', main.clear_selected_manuscript, name="clear_selected_manuscript"),
    path('manuscript/<int:id>/select', main.select_manuscript, name="manuscript_select"),
